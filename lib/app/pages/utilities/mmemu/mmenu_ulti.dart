...
class _InputTokenAndShowRestaurants extends StatefulWidget {
  const _InputTokenAndShowRestaurants();

  @override
  State<_InputTokenAndShowRestaurants> createState() =>
      _InputTokenAndShowRestaurantsState();
}

class _InputTokenAndShowRestaurantsState
    extends State<_InputTokenAndShowRestaurants> {
